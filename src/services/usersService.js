...
class UsersService {
  async getAll() {
    const res = await pool.query(
      'SELECT user_id, username, email, full_name FROM users ORDER BY user_id ASC'
    );
    return res.rows;
  }
  ...
  async create({ username, email, password, full_name, address, country_code, phone_number }) {
